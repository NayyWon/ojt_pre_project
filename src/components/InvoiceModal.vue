<template>
    <div @click="checkClick" ref="invoiceWrap" class="invoice-wrap flex flex-column">
        <form @submit.prevent="submitForm" class="invoice-content" action="">
            ...
            <div class="save flex">
                ...
                <div class="right">
                    ...
                    <button v-if="!editInvoice" type="submit" @click="publishInvoice" class="purple">Create
                        Invoice</button>
                    <button v-if="editInvoice" type="submit" class="purple" id="updateBtn">Update Invoice</button>
                </div>
            </div>
        </form>
    </div>
